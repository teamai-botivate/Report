...
def _build_full_report_prompt(report: ReportSpec) -> str:
    ...
    return (
        ...
        f"{description}\n\n"
        "Style: clean corporate BI dashboard, blue color palette, white "
        "background, clear section headers, legible sans-serif font, generous "
        "spacing between sections so nothing overlaps or is cut off, no "
        "watermarks, no extra decorative elements beyond the dashboard itself. "
